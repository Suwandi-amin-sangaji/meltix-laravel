                ...
                <div class="col-xl-12 des-xl-50">
                    <div class="card profile-greeting">
                        ...
                        <div class="card-body text-center p-t-0">
                            ...
                            <p>Selamat datang di dashboard MELTIX, solusi mudah dan cepat untuk pembelian tiket online.</p>
                            <button class="btn btn-light" onclick="window.location.href='{{ route('event.index') }}'">
                                Lihat Event Saya
                            </button>
                        </div>
